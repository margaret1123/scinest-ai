...
export const metadata: Metadata = {
  ...
  description: "How SciNest, individually developed and operated by Margaret in New Zealand, collects, uses, stores and discloses personal information.",
...
export default function PrivacyPage() {
  return (
    <LegalPage
      eyebrow="Privacy"
      title="Privacy Policy"
      intro="This policy explains how SciNest, individually developed and operated by Margaret as a New Zealand sole trader, handles personal information connected with the SciNest website, account, trial, purchase and support experience."
      updated="25 July 2026"
      sections={[
        {
          title: "Who we are",
          paragraphs: [
            "SciNest is individually developed and operated by Margaret as a New Zealand sole trader. In this policy, “SciNest”, “we”, “us” and “our” refer to the individual operator in connection with the SciNest product and website.",
          ],
        },
        {
