...
export const metadata: Metadata = {
  title: "Draft 10,000+ Word Papers with Your Own AI Key",
  description:
    "Upload once, choose ChatGPT, DeepSeek or Claude, and draft a complete paper — outline, sources, chapters all connected. Free Windows app. Start free.",
  alternates: {
...
export default function AiLongFormWriterPage() {
  return (
    <div style={{ fontFamily: '"Aptos","Segoe UI","PingFang SC","Microsoft YaHei",sans-serif', color: "#0a2030", background: "#f9fcfb" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(createBreadcrumbData(siteUrl, "writing")) }} />
