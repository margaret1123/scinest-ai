...
export default function TermsPage() {
  return (
    <LegalPage
      eyebrow="Terms"
      title="Terms of Service"
      intro="These terms govern your use of the SciNest website, trial, software licence, downloads and related support provided by Margaret, a New Zealand sole trader who individually develops and operates SciNest."
      updated="25 July 2026"
      sections={[
        { title: "Operator and acceptance", paragraphs: ["SciNest is individually developed and operated by Margaret as a New Zealand sole trader. By creating an account, starting a trial, purchasing a licence, downloading the software or using the service, you agree to these terms."] },
