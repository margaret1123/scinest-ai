...
export default function Page() {
  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <section className={styles.final}><h2>不要再把一篇长文拼成几十段零散回答。</h2><p>先确认大纲和材料，再生成一份可以继续修改的连贯草稿。</p><a className={styles.cta} href={downloadUrl}>获取 SciNest Free ↗</a></section>
