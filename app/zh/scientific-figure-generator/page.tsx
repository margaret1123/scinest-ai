...
export default function Page() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}><a className={styles.brand} href="/zh"><span>S</span>SciNest 科研小棉袄</a><nav className={styles.nav}><a href="#difference">为什么可编辑</a><a href="#workflow">生成流程</a><a href="#faq">常见问题</a></nav><a className={styles.cta} href={registerUrl}>获取 SciNest Free</a></header>
    <main>
