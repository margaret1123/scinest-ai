...
export default function Page() {
  const structuredData = [
    { "@context": "https://schema.org", "@type": "WebPage", name: "AI 科研图生成器", url: `${siteUrl}/zh/scientific-figure-generator`, inLanguage: "zh-CN", description: metadata.description, isPartOf: { "@type": "WebSite", name: "SciNest", url: siteUrl } },
    { "@context": "https://schema.org", "@type": "SoftwareApplication", name: "SciNest", alternateName: "科研小棉袄", applicationCategory: "ProductivityApplication", operatingSystem: "Windows", url: `${siteUrl}/zh/scientific-figure-generator`, featureList: ["图层编辑","拖拽排序元素","可编辑文字标签","选定区域 AI 重绘","材料绑定","科研图复用于演示文稿"], audience: { "@type": "Audience", audienceType: "研究生、本科毕业生和早期研究人员" }, author: { "@type": "Organization", name: "Jiaempower Pathways Limited" } },
  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <section className={styles.final}><h2>不要把无法纠错的漂亮图片当成科研图成品。</h2><p>用自己的研究材料生成，再继续修改和复用。</p><a className={styles.cta} href={registerUrl}>领取 30 天 Pro ↗</a></section>
