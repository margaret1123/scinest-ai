...
export default function Page() {
  return (
    <div style={{ fontFamily: '"Aptos","Segoe UI","PingFang SC","Microsoft YaHei",sans-serif', color: "#0a2030", background: "#f9fcfb" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(createBreadcrumbData(siteUrl, "powerpoint", "zh")) }} />
      ...
      <main>
        <ProductBreadcrumbs current="powerpoint" locale="zh" />
        <section style={{ maxWidth: 860, margin: "0 auto", padding: "60px 28px 40px", textAlign: "center" }}>
          ...
          <p style={{ color: "#8599a3", fontSize: 13, marginTop: 18 }}>免费开始 · 标准 PPTX 导出 · 自选模型</p>
        </section>
