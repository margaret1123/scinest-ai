...
export default function Page() {
  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <section className={styles.final}><h2>不要在 AI 生成结束后重新做一遍 PPT。</h2><p>先用自己的材料验证大纲和页面，再决定是否继续使用。</p><a className={styles.cta} href={downloadUrl}>获取 SciNest Free ↗</a></section>
